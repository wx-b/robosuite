...
So all the important definitions are in the [bread.xml](../RoboticsSuite/models/assets/objects/bread.xml) file.
```xml
<mujoco model="bread">
  <asset>
