...
if __name__ == '__main__':
    ...
    #spacenav = SpaceNavigator()
    left_ik_controller = IKController(bullet_data_path="../models/assets/bullet_data/baxter_common/left.urdf", robot_jpos_getter=robot_jpos_getter)
    right_ik_controller = IKController(bullet_data_path="../models/assets/bullet_data/baxter_common/right.urdf", robot_jpos_getter=robot_jpos_getter)
    ...
    while True:
        ...
        for i in range(100000):
            ...
            velocities = con[side].get_control(dpos=dpos, rotation=rotation)
            if side == "left":
