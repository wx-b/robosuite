...
from MujocoManip.model import MujocoObject, SingleObjectTargetTask, TableArena, DefaultCylinderObject, RandomCylinderObject, RandomBoxObject, DefaultBallObject, RandomBallObject
...
class SawyerLiftEnv(SawyerEnv):
    ...
    def __init__(self, 
        ...
        """
        # Handle parameters
        self.mujoco_object = RandomBoxObject(size_min=[0.025, 0.025, 0.03], size_max=[0.05, 0.05, 0.05])
    ...
    def _get_reference(self):
        ...
        self._ref_object_pos_indexes = self.sim.model.get_joint_qpos_addr('object_free_joint')
        self._ref_object_vel_indexes = self.sim.model.get_joint_qvel_addr('object_free_joint')
